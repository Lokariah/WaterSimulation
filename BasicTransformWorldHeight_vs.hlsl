...
SimpleWorldHeightPixelShaderInput main(BasicVertex modelVertex)
{
    SimpleWorldHeightPixelShaderInput output; // This is the data the pixel shader requires from this vertex shader
